  ...
  return (
    ...
    <div style={{backgroundColor:"black ",color:"white",height:'600px'}} >
       ...
       <ol >
        ...
        <li>
        Prepare the soil: Potatoes prefer loose, well-draining soil with plenty of organic matter. Prepare the soil by removing any weeds, rocks, or debris. Amend the soil with compost or well-rotted manure to improve its fertility and drainage.
        </li>
        <li>
        Plant at the right time: Plant potatoes when the soil has warmed up and all chances of frost have passed. The ideal soil temperature for planting is around 45 to 55 degrees Fahrenheit (7 to 13 degrees Celsius).
        </li>
        <li>
        Planting method: Potatoes can be planted directly in the ground or in containers. If planting in the ground, create furrows or trenches about 4-6 inches deep and place the seed potatoes cut-side down with eyes facing up, spacing them about 12-15 inches apart. If using containers, choose a large container and plant 2-3 seed potatoes per container.
        </li>
       </ol>
       </section>
    </div>
