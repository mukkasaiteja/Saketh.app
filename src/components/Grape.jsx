...
function Grape() {
  return (
    <div  style={{height:"1000px",margin:'30px'}}>
        <h1 style={{marginLeft:'50%'}}>Grape</h1>
         <img src="https://www.indianonshop.com/wp-content/uploads/2022/06/Graps.jpg" height={200} width={200} style={{marginLeft:'50%'}} alt="" />
         <h3>Description:-</h3>
        ...
        <div style={{border:'1px solid black',width:'700px',margin:"auto",boxShadow:"0px 0px 30px black",padding:"10px",background:"white",color:"black"}}>
            <h3>Tips</h3>
        <ol>
